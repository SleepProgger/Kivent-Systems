...
prefixes = {
    'scaling_renderer': 'kivent_scaling_renderer.',
}
...
setup(
    name='KivEnt Scaling Renderer Module',
    description='''A collection of scaling renderer for kivent.''',
    version='0.1',
    author='SleepProgger',
